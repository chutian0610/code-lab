package info.victorchu.commontool.json.gson;
...
/**
 * Builder for Gson objects and arrays
 */
public class JsonBuilder {
    ...
    NestedJsonElement retreat() throws IllegalStateException {
        if (this.currentElement.isRoot()) {
            throw new IllegalStateException("cannot retreat from root");
        }
    ...
    JsonBuilder append(JsonElement jsonElement) throws IllegalStateException {
        if (this.currentElement.element.isJsonArray()) {
            ...
            if (this.currentElement.name == null) {
                throw new IllegalStateException("tried to append JsonObject without name");
            }
