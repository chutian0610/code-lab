...
import info.victorchu.tool.mermaidjsjava.Node;

import static info.victorchu.tool.mermaidjsjava.Constant.back_slash;
import static info.victorchu.tool.mermaidjsjava.Constant.left_bracket;
import static info.victorchu.tool.mermaidjsjava.Constant.left_curly_bracket;
import static info.victorchu.tool.mermaidjsjava.Constant.left_square_bracket;
import static info.victorchu.tool.mermaidjsjava.Constant.right_arrow;
import static info.victorchu.tool.mermaidjsjava.Constant.right_bracket;
import static info.victorchu.tool.mermaidjsjava.Constant.right_curly_bracket;
import static info.victorchu.tool.mermaidjsjava.Constant.right_square_bracket;
import static info.victorchu.tool.mermaidjsjava.Constant.slash;
