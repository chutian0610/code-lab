...
import info.victorchu.toy.compiler.simpleregex.ast.*;
 ...
 * @author victorchu
 */
public class RegexNodePrintVisitor implements RegexNodeVisitor<Object,Pair<RegexNodePrintVisitor.PrintStackContext,Boolean>> {
    ...
    public static class RegexNodeFormatter implements RegexNodeVisitor<String,Void> {
